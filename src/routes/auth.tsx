    ...
    <div className="bg-blush-gradient flex min-h-[80vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-3xl border border-border/60 bg-background/95 p-8 shadow-luxe backdrop-blur">
        <div className="mb-6 flex flex-col items-center gap-3 text-center">
          <img src={brandLogo || logo} alt="" className="h-16 w-16 rounded-full object-cover ring-2 ring-champagne/50" />
          <div>
        ...
        >
          <svg className="h-5 w-5" viewBox="0 0 24 24">
            ...
            <path fill="#FBBC05" d="M5.84 14.1a6.9 6.9 0 010-4.41V6.85H2.18a11 11 0 000 10.3l3.66-2.85z" />
            <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 6.85l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38z" />
          </svg>
        ...
        <p className="mt-6 text-center text-[11px] text-muted-foreground">
          ...
          &{" "}
          <Link to="/policies/$slug" params={{ slug: "privacy" }} className="underline">
            Privacy Policy
          </Link>
          .
        </p>
      ...
      <style>{`
        .input{width:100%;border:1px solid var(--color-border);background:var(--color-background);border-radius:9999px;padding:.75rem 1.25rem;font-size:.875rem;outline:none;transition:border-color .2s,box-shadow .2s}
